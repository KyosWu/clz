...
class Weibo(object):
    cookie = {'Cookie': '_T_WM=18b607ec0098119e290e118f1e91b8e4; SUB=_2A25w3xCJDeRhGeRL4lUX8yjEzzmIHXVQI7DBrDV6PUJbkdAKLVnwkW1NUsPbDwBEB4nxdwzPb0m5oz7HNx93v-_M; SUHB=0tKrKtDI9uzHKK; SCF=AgLN_zPyd-hMV1kEjbcPclLwcxAuyzy_IUpakiA39PF5uvaWwiaFNSVTRo8lNigwYGBChMEPgnNIa2lpyMbQ40k.; SSOLoginState=1574658264'}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        since_date = '2011-10-21'  # 起始时间，即爬取发布日期从该值到现在的微博，形式为yyyy-mm-dd
